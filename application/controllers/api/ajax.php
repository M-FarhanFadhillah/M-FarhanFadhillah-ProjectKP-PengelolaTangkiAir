	...
	public function getTableBarang()
	{
		...
		if (sizeof($data['data']) == 0) {
			...
			foreach ($data['data'] as $dt) {
				...
				$content .= "<td><button type='button' class='btn btn-success btn-sm' href='#' onClick='pilih(&quot;" . $dt['id_barang'] . "&quot;,&quot;" . $dt['nama'] . "&quot;,&quot;" . $dt['kategori'] . "&quot;,&quot;" . $dt['radius'] . "&quot;,&quot;" . $dt['harga'] . "&quot;)' data-dismiss='modal'>pilih</button></td>";
				$content .= "</tr>";
			}
		}
