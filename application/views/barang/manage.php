					...
					<form  class="form-horizontal" method="post" action="<?php echo site_url("barang/save")?>"  >
						...
						<div class="box-body">
							<div class="form-group">
								<label for="id_barang" class="col-sm-2 control-label">ID Tanki</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="id_radius" class="col-sm-2 control-label">Kategori</label>
								<div class="col-sm-3">
								   <select class="form-control" name="id_radius">
									  <?php foreach ($radius[0] as $kt):?>
									  <option value="<?php echo $kt['id_radius'];?>" <?php echo $data->id_radius == $kt['id_radius'] ? ' selected' : '';?> ><?php echo $kt['radius']?></option>
									  <?php endforeach;?>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
								  <input type="text" class="form-control"  required="required" id="quantity"  name="quantity" placeholder="input quantity" value="<?php echo $data->quantity; ?>"  >
								</div>
							</div>
							<div class="form-group">
								<label for="harga" class="col-sm-2 control-label">HARGA</label>
								<div class="col-sm-3">
								  <input type="text" class="form-control"  required="required" id="harga"  name="harga" placeholder="input harga" value="<?php echo $data->quantity; ?>"  >
								</div>
							</div>
						</div>
