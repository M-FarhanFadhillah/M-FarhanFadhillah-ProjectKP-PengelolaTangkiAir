...
<head>
  ...
  <link rel="icon" href="<?php echo base_url('assets/images/logo_way_rilau.png') ?>">
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="" class="logo">
        ...
        <span class="logo-lg"><b>PDAM Way Rilau</b></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url('assets/template/dist/img/avatar5.png') ?>" class="user-image"
                  alt="User Image">
                <span class="hidden-xs">
                  <?php echo $CI->getLoginName(); ?>
                </span>
              </a>
            </li>
            <li>
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img src="<?php echo base_url('assets/template/dist/img/avatar5.png') ?>" class="img-circle"
              alt="User Image">
          </div>
        ...
        <ul class="sidebar-menu">
          ...
          <?php if ($CI->getStatus() == '1'): ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo site_url('radius') ?>"><i class="fa fa-circle-o"></i> Radius</a></li>
                <li><a href="<?php echo site_url('barang') ?>"><i class="fa fa-circle-o"></i> Tanki</a></li>
          ...
          <?php if ($CI->getStatus() == '3' || $CI->getStatus() == '1'): ?>
            <li>
              <a href="<?php echo site_url('pengiriman/manage') ?>">
                <i class="fa fa-shopping-cart"></i> <span>Pembelian</span> <i class="fa pull-right"></i>
              </a>
            </li>
          <?php endif; ?>
          <?php if ($CI->getStatus() == '3' || $CI->getStatus() == '1'): ?>
          ...
          <?php if ($CI->getStatus() == '2' || $CI->getStatus() == '1'): ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('pengiriman/rekap') ?>"><i class="fa fa-circle-o"></i> Laporan
                    Pengiriman</a></li>
              </ul>
            </li>
          <?php endif; ?>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo site_url('changepassword') ?>"><i class="fa fa-circle-o"></i> Ganti Password</a>
              </li>
            </ul>
          </li>
        </ul>
