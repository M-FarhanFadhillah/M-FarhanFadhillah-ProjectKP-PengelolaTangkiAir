...
<script>
	var selectedmodal = 1;
	var lastBarang = <?php echo $list_barang != "" ? json_encode($list_barang) : '[]' ?>;
	$(function () {
	...
	function pilih(id, nama, other, other2, other3) {
		if (selectedmodal == 1) {
			...
			$("#btnpilih").attr("disabled", "enabled");
		}
	...
	function deleteBarang(a) {
		$(a).closest("tr").remove()
		$("#btnpilih").removeAttr("disabled", "disabled");
	}
</script>
				...
				<div class="box box-primary">
					<form class="form-horizontal" method="post" action="<?php echo site_url("pengiriman/save") ?>">
						<input type="hidden" class="form-control" id="id" name="id"
							value="<?php echo $data->id_pengiriman; ?>">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" id="id_pengiriman" name="id_pengiriman"
										value="<?php echo $data->id_pengiriman == "" ? $data->autocode : $data->id_pengiriman; ?>"
										readonly>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" required="required" class="form-control datepicker" id="tanggal"
										data-date-format="dd/mm/yyyy" placeholder="select tanggal" name="tanggal"
										value="<?php echo $data->tanggal != "" ? date("d/m/Y", strtotime($data->tanggal)) : date("d/m/Y"); ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="id_pelanggan"
										placeholder="pilih pelanggan" name="id_pelanggan"
										value="<?php echo $data->id_pelanggan; ?>" readonly />
								</div>
								<?php if ($data->status == "" || $data->status == "1") { ?>
									<a class="btn btn-default btn-sm" data-toggle="modal" data-target="#ref-table-pelanggan"
										href="#"><span class="glyphicon glyphicon-search"></span></a>
								<?php } ?>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="pelanggan" name="pelanggan"
										value="<?php echo $data->pelanggan; ?>" readonly />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="id_kurir" placeholder="pilih kurir"
										name="id_kurir" value="<?php echo $data->id_kurir; ?>" readonly />
								</div>
								<?php if ($data->status == "" || $data->status == "1") { ?>
									<a class="btn btn-default btn-sm" data-toggle="modal" data-target="#ref-table-kurir"
										href="#"><span class="glyphicon glyphicon-search"></span></a>
								<?php } ?>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="kurir" name="kurir"
										value="<?php echo $data->kurir; ?>" readonly />
								</div>
							</div>
							<div class="form-group">
								<label for="no_kendaraan" class="col-sm-2 control-label">No Kendaraan</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" required="required" id="no_kendaraan"
										name="no_kendaraan" placeholder="input no kendaraan"
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<select class="form-control input-sm" name="status">
											<option value="1" <?php echo $data->status == "1" ? ' selected' : ''; ?>>Diproses
											</option>
											<option value="2" <?php echo $data->status == "2" ? ' selected' : ''; ?>>Dikirim
											</option>
											<option value="3" <?php echo $data->status == "3" ? ' selected' : ''; ?>>Diterima
											</option>
											<option value="5" <?php echo $data->status == "5" ? ' selected' : ''; ?>>Ditolak
											</option>
										</select>
									</div>
								</div>
							...
							<div class="col-md-12">
								<div class="panel panel-default form-master">
									...
									<div class="panel-body">
										<?php if ($data->status == '1' || $data->status == "") { ?>
											<button type="button" class="btn btn-success  pull-right btnpilih" id="btnpilih"
												name="btnpilih" data-toggle="modal" data-target="#ref-table-barang" href="#"
												<?php echo $jumlah_barang >= 1 ? 'disabled' : '' ?>>pilih
												barang</button>
										<?php } ?>
										<table class="table table-striped table-small tblbarang">
											...
											<tbody>
												<?php if ($data->id_pengiriman != "" && $barang != null): ?>

													<?php foreach ($barang as $br): ?>

														<tr>
															<td><input type='hidden' name='detail[id_barang][]'
																	value="<?php echo $br['id_barang']; ?>"><?php echo $br['id_barang']; ?></td>
															<td>
																<?php echo $br['nama_barang']; ?>
															</td>
															<td>
																<?php echo $br['kategori']; ?>
															</td>
															<td>
																<?php echo $br['radius']; ?>
															</td>
															...
															<td>
																<input type='text' class="form-control"
																	name='detail[qty][<?php echo $br['id_barang']; ?>]'
																	value='<?php echo $br['qty']; ?>' size='5' <?php echo $data->status == "1" || $data->status == "" ? "" : "readonly" ?>>
															</td>
															<?php if ($data->status == "1" || $data->status == "") { ?>
																<td>
																	<a class='btn btn-danger btn-xs delete' href='javascript://'
																		onclick='deleteBarang(this)'><span
						...
						<div class="box-footer">
							...
							<button type="submit" class="btn btn-success" name="action" value="saveexit">Save &
								Exit</button>
							<?php if ($data->id_pengiriman != "") { ?>
								<a href="<?php echo site_url("pengiriman/spk/" . $data->id_pengiriman) ?>"
									class="btn btn-info">Cetak SPK</a>
							<?php } ?>
...
<div class="modal fade" id="ref-table-barang" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	aria-hidden="true">
	<div class="modal-dialog ajax-modal" style="margin-top:100px;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<a href="<?php echo site_url('barang/manage') ?>" class="btn btn-primary btn-sm"
						style=" margin-left: 1.2em;">Add</a>
					<div class="form-filter-modal">
						<form class="form-inline" method="get" action="#">
							<div class="form-group">
								<input type="text" class="form-control input-sm" id="keyword-barang"
									placeholder="Keyword" name="keyword" value="">
							</div>
...
<div class="modal fade" id="ref-table-pelanggan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	aria-hidden="true">
	<div class="modal-dialog ajax-modal" style="margin-top:100px;">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="row">
					<a href="<?php echo site_url('pelanggan/manage') ?>" class="btn btn-primary btn-sm"
						style=" margin-left: 1.2em;">Add</a>
					<div class="form-filter-modal">
						<form class="form-inline" method="get" action="#">
							<div class="form-group">
								<input type="text" class="form-control input-sm" id="keyword-pelanggan"
									placeholder="Keyword" name="keyword" value="">
							</div>
...
<div class="modal fade" id="ref-table-kurir" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	aria-hidden="true">
	<div class="modal-dialog ajax-modal" style="margin-top:100px;">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="row">
					<a href="<?php echo site_url('kurir/manage') ?>" class="btn btn-primary btn-sm"
						style=" margin-left: 1.2em;">Add</a>
					<div class="form-filter-modal">
						<form class="form-inline" method="get" action="#">
							<div class="form-group">
								<input type="text" class="form-control input-sm" id="keyword-kurir"
									placeholder="Keyword" name="keyword" value="">
							</div>
