					...
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
							<form class="form-inline" method="get" action="<?php echo site_url("pengiriman") ?>">
								...
								<button type="submit"
									class="btn btn-primary btn-sm glyphicon glyphicon-search"></button>
							...
							<tbody>
								<?php foreach ($data as $dt): ?>
									<tr>
										...
										<td>
											<?php echo date("d-m-Y", strtotime($dt['tanggal'])); ?>
										</td>
										<td>
							...
							<td><?php echo $dt['keterangan']; ?></td> -->
										...
										<th>
											<a class="btn btn-primary btn-xs" target="_blank" 
												href="<?php echo site_url("pengiriman/cetak") . "/" . $dt['id_pengiriman']; ?>"><span
													class="glyphicon glyphicon-print"></span></a> <!-- Penjsioaj -->
											<a class="btn btn-warning btn-xs"
												href="<?php echo site_url("pengiriman/manage") . "/" . $dt['id_pengiriman']; ?>"><span
													class="glyphicon glyphicon-edit"></span></a>
											<a class="btn btn-danger btn-xs"
												data-href="<?php echo site_url("pengiriman/delete") . "/" . $dt['id_pengiriman']; ?>"
												data-toggle="modal" data-target="#confirm-delete" href="#"><span
